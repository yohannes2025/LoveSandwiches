...
def get_stock_values(data):
    ...
    """
    # Retrieve headings from the first row of the "stock" worksheet
    headings = SHEET.worksheet("stock").row_values(1)

    # Create a dictionary mapping headings to data values
...
def main():
    ...
    # Call the get_stock_values function
    stock_values = get_stock_values(stock_data)

    # Print the stock values dictionary
    print("Stock values dictionary:")
    print(stock_values)
